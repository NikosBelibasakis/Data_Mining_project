...
time_threshold =  timedelta(milliseconds=100)  # 100 ms the time threshold
...
for label, group in grouped_data:
    ...
    for idx, row in group.iterrows():
        ...
        # Adjust the timestamp by subtracting the cumulative time difference
        current_time = current_timestamp - time_difference
